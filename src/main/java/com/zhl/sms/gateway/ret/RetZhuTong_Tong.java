 ...
 *
 */
public class RetZhuTong_Tong implements RetAnalysis  {
	
	private Logger logger = Logger.getLogger(RetZhuTong_Tong.class);
	
	@Override
	public Map<String,Object> send(String smsId, String outSmsNo, String result){
		logger.info("开始解析：【助通_通知】服务，【服务编号】:"+smsId+"【返回参数】：" + result);
		...
		logger.info("解析完成：【助通_通知】服务，【服务编号】:"+smsId+"【返回参数】：" + returnMap.toString());
		return returnMap;
	}
